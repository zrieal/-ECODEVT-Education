...
### \[1.3\] School category
```{r}
epiDisplay::tab1(CAA$schoolcateg_categ, cum.percent = TRUE, graph = FALSE)
```

```{r}
count<-table(CAA$schoolcateg_categ) #this is to see how many are movies in your data and how many are TV shows.
count
```
...
ggplot(count_df, aes(x = "", y = count, fill = type)) +
  geom_bar(width = 1, stat = "identity", color = "white") +
  coord_polar("y") +
  scale_fill_manual(values = c("blue", "green","red")) +
  labs(title = "School Categories", x = NULL, y = NULL, fill = "Category")
```
------------------------------------------------------------------------
